...
if (isset($_POST['form_sent']))
{
	...
	switch ($section)
	{
		case 'setup':
		{
			...
			if (!file_exists(PUN_ROOT.'style/'.$form['default_style'].'/'.$form['default_style'].'.php'))
				message($lang_common['Bad request']);
			if (!file_exists(PUN_ROOT.'lang/'.$form['default_lang'].'/common.php'))
				message($lang_common['Bad request']);
			if (!file_exists(PUN_ROOT.'include/url/'.$form['sef'].'.php'))
				message($lang_common['Bad request']);
	...
	redirect(pun_link($pun_url['admin_options_'.$section]), $lang_admin['Options updated'].' '.$lang_admin['Redirect']);
}
				...
				<fieldset class="frm-set set<?php echo ++$pun_page['set_count'] ?>">
					...
					<div class="frm-fld text">
						<label for="fld<?php echo ++$pun_page['fld_count'] ?>">
							...
							<span class="fld-input"><input type="text" id="fld<?php echo $pun_page['fld_count'] ?>" name="form[board_title]" size="50" maxlength="255" value="<?php echo pun_htmlencode($pun_config['o_board_title']) ?>" /></span><br />
						</label>
					</div>
					<div class="frm-fld text">
						<label for="fld<?php echo ++$pun_page['fld_count'] ?>">
							<span class="fld-label"><?php echo $lang_admin['Board description'] ?></span><br />
							<span class="fld-input"><input type="text" id="fld<?php echo $pun_page['fld_count'] ?>" name="form[board_desc]" size="50" maxlength="255" value="<?php echo pun_htmlencode($pun_config['o_board_desc']) ?>" /></span><br />
						</label>
					</div>
...
?>
					...
					<div class="frm-fld select">
						<label for="fld<?php echo ++$pun_page['fld_count'] ?>">
							...
							<span class="fld-input"><select id="fld<?php echo $pun_page['fld_count'] ?>" name="form[default_timezone]">
								<option value="-12"<?php if ($pun_config['o_default_timezone'] == -12) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC-12:00'] ?></option>
								<option value="-11"<?php if ($pun_config['o_default_timezone'] == -11) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC-11:00'] ?></option>
								<option value="-10"<?php if ($pun_config['o_default_timezone'] == -10) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC-10:00'] ?></option>
								<option value="-9.5"<?php if ($pun_config['o_default_timezone'] == -9.5) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC-09:30'] ?></option>
								<option value="-9"<?php if ($pun_config['o_default_timezone'] == -9) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC-09:00'] ?></option>
								<option value="-8"<?php if ($pun_config['o_default_timezone'] == -8) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC-08:00'] ?></option>
								<option value="-7"<?php if ($pun_config['o_default_timezone'] == -7) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC-07:00'] ?></option>
								<option value="-6"<?php if ($pun_config['o_default_timezone'] == -6) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC-06:00'] ?></option>
								<option value="-5"<?php if ($pun_config['o_default_timezone'] == -5) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC-05:00'] ?></option>
								<option value="-4"<?php if ($pun_config['o_default_timezone'] == -4) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC-04:00'] ?></option>
								<option value="-3.5"<?php if ($pun_config['o_default_timezone'] == -3.5) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC-03:30'] ?></option>
								<option value="-3"<?php if ($pun_config['o_default_timezone'] == -3) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC-03:00'] ?></option>
								<option value="-2"<?php if ($pun_config['o_default_timezone'] == -2) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC-02:00'] ?></option>
								<option value="-1"<?php if ($pun_config['o_default_timezone'] == -1) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC-01:00'] ?></option>
								<option value="0"<?php if ($pun_config['o_default_timezone'] == 0) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC'] ?></option>
								<option value="1"<?php if ($pun_config['o_default_timezone'] == 1) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC+01:00'] ?></option>
								<option value="2"<?php if ($pun_config['o_default_timezone'] == 2) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC+02:00'] ?></option>
								<option value="3"<?php if ($pun_config['o_default_timezone'] == 3) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC+03:00'] ?></option>
								<option value="3.5"<?php if ($pun_config['o_default_timezone'] == 3.5) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC+03:30'] ?></option>
								<option value="4"<?php if ($pun_config['o_default_timezone'] == 4) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC+04:00'] ?></option>
								<option value="4.5"<?php if ($pun_config['o_default_timezone'] == 4.5) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC+04:30'] ?></option>
								<option value="5"<?php if ($pun_config['o_default_timezone'] == 5) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC+05:00'] ?></option>
								<option value="5.5"<?php if ($pun_config['o_default_timezone'] == 5.5) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC+05:30'] ?></option>
								<option value="5.75"<?php if ($pun_config['o_default_timezone'] == 5.75) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC+05:45'] ?></option>
								<option value="6"<?php if ($pun_config['o_default_timezone'] == 6) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC+06:00'] ?></option>
								<option value="6.5"<?php if ($pun_config['o_default_timezone'] == 6.5) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC+06:30'] ?></option>
								<option value="7"<?php if ($pun_config['o_default_timezone'] == 7) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC+07:00'] ?></option>
								<option value="8"<?php if ($pun_config['o_default_timezone'] == 8) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC+08:00'] ?></option>
								<option value="8.75"<?php if ($pun_config['o_default_timezone'] == 8.75) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC+08:45'] ?></option>
								<option value="9"<?php if ($pun_config['o_default_timezone'] == 9) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC+09:00'] ?></option>
								<option value="9.5"<?php if ($pun_config['o_default_timezone'] == 9.5) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC+09:30'] ?></option>
								<option value="10"<?php if ($pun_config['o_default_timezone'] == 10) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC+10:00'] ?></option>
								<option value="10.5"<?php if ($pun_config['o_default_timezone'] == 10.5) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC+10:30'] ?></option>
								<option value="11"<?php if ($pun_config['o_default_timezone'] == 11) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC+11:00'] ?></option>
								<option value="11.5"<?php if ($pun_config['o_default_timezone'] == 11.5) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC+11:30'] ?></option>
								<option value="12"<?php if ($pun_config['o_default_timezone'] == 12) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC+12:00'] ?></option>
								<option value="12.75"<?php if ($pun_config['o_default_timezone'] == 12.75) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC+12:45'] ?></option>
								<option value="13"<?php if ($pun_config['o_default_timezone'] == 13) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC+13:00'] ?></option>
								<option value="14"<?php if ($pun_config['o_default_timezone'] == 14) echo ' selected="selected"' ?>><?php echo $lang_profile['UTC+14:00'] ?></option>
							</select></span>
						</label>
					</div>
					<div class="frm-fld text">
						<label for="fld<?php echo ++$pun_page['fld_count'] ?>">
							...
							<span class="fld-input"><input type="text" id="fld<?php echo $pun_page['fld_count'] ?>" name="form[time_format]" size="25" maxlength="25" value="<?php echo pun_htmlencode($pun_config['o_time_format']) ?>" /></span><br />
					...
					<div class="frm-fld text">
						<label for="fld<?php echo ++$pun_page['fld_count'] ?>">
							...
							<span class="fld-input"><input type="text" id="fld<?php echo $pun_page['fld_count'] ?>" name="form[date_format]" size="25" maxlength="25" value="<?php echo pun_htmlencode($pun_config['o_date_format']) ?>" /></span><br />
				...
				<fieldset class="frm-set set<?php echo ++$pun_page['set_count'] ?>">
					...
					<div class="frm-fld text textarea">
						<label for="fld<?php echo ++$pun_page['fld_count'] ?>">
							...
							<span class="fld-input"><textarea id="fld<?php echo $pun_page['fld_count'] ?>" name="form[additional_navlinks]" rows="3" cols="55"><?php echo pun_htmlencode($pun_config['o_additional_navlinks']) ?></textarea></span>
						</label>
					</div>
...
<?php ($hook = get_hook('aop_features_pre_general_part')) ? eval($hook) : null; ?>
			<div class="frm-part part<?php echo ++ $pun_page['part_count'] ?>">
				<h3><span><?php printf($lang_admin['General part head'], $pun_page['part_count']) ?></span></h3>
				<fieldset class="frm-set set<?php echo ++$pun_page['set_count'] ?>">
					<legend class="frm-legend"><strong><?php echo $lang_admin['General features'] ?></strong></legend>
				...
				<fieldset class="frm-set set<?php echo ++$pun_page['set_count'] ?>">
					...
					<div class="frm-fld">
						<label for="fld<?php echo ++$pun_page['fld_count'] ?>">
							...
							<span class="fld-input"><input type="text" id="fld<?php echo $pun_page['fld_count'] ?>" name="form[avatars_dir]" size="35" maxlength="50" value="<?php echo pun_htmlencode($pun_config['o_avatars_dir']) ?>" /></span>
...
else if ($section == 'announcements')
{
	...
	define('PUN_PAGE_SECTION', 'options');
	define('PUN_PAGE', 'admin-options-announcements');
	require PUN_ROOT.'header.php';
...
<?php echo generate_admin_menu(); ?>
	...
	<div class="main-content frm">
		...
		<form class="frm-form" method="post" accept-charset="utf-8" action="<?php echo pun_link($pun_url['admin_options_announcements']) ?>">
			<div class="hidden">
				<input type="hidden" name="csrf_token" value="<?php echo generate_form_token(pun_link($pun_url['admin_options_announcements'])) ?>" />
				<input type="hidden" name="form_sent" value="1" />
			</div>
			<fieldset class="frm-set set<?php echo ++$pun_page['set_count'] ?>">
				...
				<div class="frm-fld text textarea">
					<label for="fld<?php echo ++$pun_page['fld_count'] ?>">
						...
						<span class="fld-input"><textarea id="fld<?php echo $pun_page['fld_count'] ?>" name="form[announcement_message]" rows="5" cols="55"><?php echo pun_htmlencode($pun_config['o_announcement_message']) ?></textarea></span>
				...
				<fieldset class="frm-set set<?php echo ++$pun_page['set_count'] ?>">
					...
					<div class="frm-fld text textarea">
						<label for="fld<?php echo ++$pun_page['fld_count'] ?>">
							...
							<span class="fld-input"><textarea id="fld<?php echo $pun_page['fld_count'] ?>" name="form[rules_message]" rows="10" cols="55"><?php echo pun_htmlencode($pun_config['o_rules_message']) ?></textarea></span>
			...
			<fieldset class="frm-set set<?php echo ++$pun_page['set_count'] ?>">
				...
				<div class="frm-fld text textarea">
					<label for="fld<?php echo ++$pun_page['fld_count'] ?>">
						...
						<span class="fld-input"><textarea id="fld<?php echo $pun_page['fld_count'] ?>" name="form[maintenance_message]" rows="5" cols="55"><?php echo pun_htmlencode($pun_config['o_maintenance_message']) ?></textarea></span>
				...
				<fieldset class="frm-set set<?php echo ++$pun_page['set_count'] ?>">
					...
					<div class="frm-fld text textarea">
						<label for="fld<?php echo ++$pun_page['fld_count'] ?>">
							...
							<span class="fld-input"><textarea id="fld<?php echo $pun_page['fld_count'] ?>" name="form[mailing_list]" rows="5" cols="55"><?php echo pun_htmlencode($pun_config['o_mailing_list']) ?></textarea></span><br />
				...
				<fieldset class="frm-set set<?php echo ++$pun_page['set_count'] ?>">
					...
					<div class="frm-fld text">
						<label for="fld<?php echo ++$pun_page['fld_count'] ?>">
							...
							<span class="fld-input"><input type="text" id="fld<?php echo $pun_page['fld_count'] ?>" name="form[smtp_host]" size="35" maxlength="100" value="<?php echo pun_htmlencode($pun_config['o_smtp_host']) ?>" /></span><br />
					...
					<div class="frm-fld text">
						<label for="fld<?php echo ++$pun_page['fld_count'] ?>">
							...
							<span class="fld-input"><input type="text" id="fld<?php echo $pun_page['fld_count'] ?>" name="form[smtp_user]" size="35" maxlength="50" value="<?php echo pun_htmlencode($pun_config['o_smtp_user']) ?>" /></span><br />
					...
					<div class="frm-fld text">
						<label for="fld<?php echo ++$pun_page['fld_count'] ?>">
							...
							<span class="fld-input"><input type="text" id="fld<?php echo $pun_page['fld_count'] ?>" name="form[smtp_pass]" size="35" maxlength="50" value="<?php echo pun_htmlencode($pun_config['o_smtp_pass']) ?>" /></span><br />
