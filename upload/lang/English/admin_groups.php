...
'Edit groups subhead'			=>	'Edit/remove groups',
'Edit groups info'				=>	'The pre-defined groups Guests, Administrators, Moderators and Members cannot be removed. They can however be edited. Please note though, that in some groups, some options are unavailable (e.g. the <em>edit posts</em> permission for guests). Administrators always have full permissions.',
'Edit link'						=>	'Edit',
'Remove link'					=>	'Remove',
...
'Remove group head'				=>	'Remove group',
'Move users subhead'			=>	'Move users currently in group',
'Move users info'				=>	'The group <strong>%s</strong> currently has <strong>%s</strong> members. Please select a group to which these members will be assigned upon removal.',
