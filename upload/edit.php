...
$page_title = array($pun_config['o_board_title'], $lang_post['Edit post']);
...
<?php if ($can_edit_subject): ?>						<label class="required"><strong><?php echo $lang_common['Subject'] ?></strong><br />
