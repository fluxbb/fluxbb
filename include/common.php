...
$db = new Database('mysql:dbname='.$db_name.';host='.$db_host, array('username' => $db_username, 'password' => $db_password, 'prefix' => $db_prefix, 'debug' => defined('PUN_DEBUG')), null); // TODO: Tidy the config
