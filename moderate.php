...
if (!empty($topic_ids))
{
	...
	// Select topics
	$query = $db->select(array('id' => 'id', 'poster' => 'poster', 'subject' => 'subject', 'posted' => 'posted', 'last_post' => 'last_post', 'last_post_id' => 'last_post_id', 'last_poster' => 'last_poster', 'num_views' => 'num_views', 'num_replies' => 'num_replies', 'closed' => 'closed', 'sticky' => 'sticky', 'moved_to' => 'moved_to', 'mark_time' => 'tt.mark_time'), 'topics AS t');
