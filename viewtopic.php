...
while ($cur_post = $db->fetch_assoc($result))
{
	...
	if ($cur_post['poster_id'] > 1)
	{
		...
		{
			$user_info[] = '<dd><a href="moderate.php?get_host='.$cur_post['id'].'" title="'.$cur_post['poster_ip'].'">'.$lang_topic['IP Address Logged'].'</a></span></dd>';
	...
	else
	{
		...
		if ($pun_user['is_admmod'])
			$user_info[] = '<dd><span>'.$lang_topic['IP'].' <a href="moderate.php?get_host='.$cur_post['id'].'">'.$cur_post['poster_ip'].'</a></span></dd>';
