		...
		<div id="adstats" class="box">
			<div class="inbox">
				<dl>
					...
					<dd>
						<a href="http://fluxbb.org/community/irc.html"><?php echo $lang_admin_index['IRC label'] ?></a> - <a href="http://fluxbb.org/forums/index.php"><?php echo $lang_admin_index['Forum label'] ?></a>
					</dd>
				</dl>
			</div>
		</div>
