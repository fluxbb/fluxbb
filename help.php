...
<div class="box">
	<div class="inbox">
		...
		<p><code>[url=<?php echo pun_htmlspecialchars($pun_config['o_base_url'].'/') ?>]<?php echo pun_htmlspecialchars($pun_config['o_board_title']) ?>[/url]</code> <?php echo $lang_help['produces'] ?> <samp><a href="<?php echo pun_htmlspecialchars($pun_config['o_base_url'].'/') ?>"><?php echo pun_htmlspecialchars($pun_config['o_board_title']) ?></a></samp></p>
		<p><code>[url]<?php echo pun_htmlspecialchars($pun_config['o_base_url'].'/') ?>[/url]</code> <?php echo $lang_help['produces'] ?> <samp><a href="<?php echo pun_htmlspecialchars($pun_config['o_base_url'].'/') ?>"><?php echo pun_htmlspecialchars($pun_config['o_base_url'].'/') ?></a></samp></p>
...
foreach ($smiley_groups as $smiley_img => $smiley_texts)
	echo "\t\t".'<p><code>'.implode('</code> '.$lang_common['and'].' <code>', $smiley_texts).'</code> <span>'.$lang_help['produces'].'</span> <samp><img src="'.pun_htmlspecialchars($pun_config['o_base_url']).'/img/smilies/'.$smiley_img.'" width="15" height="15" alt="'.$smiley_texts[0].'" /></samp></p>'."\n";
