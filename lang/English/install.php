...
'Wrong Mail'			=>	'The administrator email address you entered is invalid.',
...
'Database confirm password'	=>	'Database confirm password',
...
'Alert cache'		=>	'<strong>The cache directory is currently not writable!</strong> In order for FluxBB to function properly, the directory named <em>cache</em> must be writable by PHP. Use chmod to set the appropriate directory permissions. If in doubt, chmod to 0777.',
...
'FluxBB has been fully installed'	=>	'FluxBB has been fully installed! You may now <a href="index.php">go to the forum index</a>.',
