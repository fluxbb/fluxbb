...
'Promote user legend'				=>	'Promote user to the next group',
'Promote user info'				=>	'User has reached the auto-promote post limit (%d) but is still in group "%s". You can promote to the "%s" group.',
