...
$lang_payment = array(
    'PayPal 1'			    =>	'Sign in to your PayPal account using your web browser. Click %sSend &amp; Request%s at the top of submit Transaction ID, and email address associated to your PayPal account e page. In the textbox, type in the email address shown below.',
    'PayPal 2'              =>  'Enter %s for the amount, EUR for the currency, and enter the phrase below for the note and click %sContinue%s.',
    'PayPal 3'              =>  'Now, select the above option %sSending to a friend%s, if prompted.',
    'PayPal 4'              =>  'You must send the money using the %sFriends &amp; Family%s option! All other payments than &apos;Friends &amp; Family&aåps; will result in a ban!',
